...
public class ConductorControlador {
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Conductor eConductor,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.guardarExitoso",new Object[] {  eConductor.getFechaCreacion().substring(0, 9),eConductor.getFechaCreacion().substring(10),principal.getIdentidad() },locale);
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody Conductor eConductor,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.actualizarExitoso",new Object[] {  eConductor.getFechaActualizacion().substring(0, 9),eConductor.getFechaActualizacion().substring(10),principal.getIdentidad() },locale);;
        	this.transaccion.commit(estadoTransaccion);
		} catch (Exception ex){
			ex.printStackTrace();
			this.transaccion.rollback(estadoTransaccion);
	...
	public @ResponseBody RespuestaCompuesta actualizarEstadoRegistro(@RequestBody Conductor eConductor,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
