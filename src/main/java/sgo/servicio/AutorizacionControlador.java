...
public class AutorizacionControlador {
	...
	public @ResponseBody RespuestaCompuesta recuperaRegistrosPorCodigoInterno(String codigoInterno, Locale locale){
		...
		try {			
            ...
            if(!buscaPorCodigo.contenido.carga.isEmpty()){
            	...
            	while(itrBuscaPorCodigo.hasNext()){
            		...
            		RespuestaCompuesta buscaUsuarios = dAutorizacionUsuario.recuperarAutorizacionesPorAutorizacion(eAutorizacion.getId());
	...
	public @ResponseBody RespuestaCompuesta recuperaRegistrosPorAutorizacion(HttpServletRequest httpRequest, Locale locale){
	...
	public @ResponseBody RespuestaCompuesta recuperaAutorizacion(int idUsuario, int idAutorizacion, Locale locale){
		System.out.println("entra en recuperaRegistrosPorCodigoInterno");
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		try {			
	...
	public @ResponseBody RespuestaCompuesta guardarValidarAutorizacion(@RequestBody AutorizacionEjecutada eAutorizacionEjecutada, HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.guardarExitoso",new Object[] {  eAutorizacionEjecutada.getFechaCreacion().substring(0, 9),eAutorizacionEjecutada.getFechaCreacion().substring(10),principal.getIdentidad() },locale);
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Autorizacion eAutorizacion,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		Bitacora eBitacora= null;
		String ContenidoAuditoria ="";
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.guardarExitoso",new Object[] {  eAutorizacion.getFechaCreacion().substring(0, 9),eAutorizacion.getFechaCreacion().substring(10),principal.getIdentidad() },locale);
        	this.transaccion.commit(estadoTransaccion);
		} catch (Exception ex){
			this.transaccion.rollback(estadoTransaccion);
			ex.printStackTrace();
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody AutorizacionUsuario eAutorizacionUsuario,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
...
@RequestMapping(value = URL_ACTUALIZAR_ESTADO_RELATIVA ,method = RequestMethod.POST)
	public @ResponseBody RespuestaCompuesta actualizarEstadoRegistro(@RequestBody Autorizacion eAutorizacion,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.actualizarExitoso",new Object[] {  eAutorizacion.getFechaActualizacion().substring(0, 9),eAutorizacion.getFechaActualizacion().substring(10),principal.getIdentidad() },locale);;
        	this.transaccion.commit(estadoTransaccion);
		} catch (Exception ex){
			ex.printStackTrace();
			this.transaccion.rollback(estadoTransaccion);
