...
public class OperacionControlador {
 ...
 @RequestMapping(URL_GESTION_RELATIVA)
	public ModelAndView mostrarFormulario( Locale locale){
      ...
      listadoClientes= (ArrayList<Cliente>) respuesta.contenido.carga;
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Operacion eOperacion,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.guardarExitoso",new Object[] {  eOperacion.getFechaCreacion().substring(0, 9),eOperacion.getFechaCreacion().substring(10),principal.getIdentidad() },locale);
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody Operacion eOperacion,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
	...
	public @ResponseBody RespuestaCompuesta actualizarEstadoRegistro(@RequestBody Operacion eEntidad,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
