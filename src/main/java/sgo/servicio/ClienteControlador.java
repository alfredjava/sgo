...
public class ClienteControlador {
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Cliente eCliente,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody Cliente eCliente,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
		...
		try {
        	...
        	respuesta.mensaje=gestorDiccionario.getMessage("sgo.actualizarExitoso",new Object[] {  eCliente.getFechaActualizacion().substring(0, 9),eCliente.getFechaActualizacion().substring(10),principal.getIdentidad() },locale);;
        	this.transaccion.commit(estadoTransaccion);
		} catch (Exception ex){
			ex.printStackTrace();
			this.transaccion.rollback(estadoTransaccion);
	...
	public @ResponseBody RespuestaCompuesta actualizarEstadoRegistro(@RequestBody Cliente eEntidad,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
