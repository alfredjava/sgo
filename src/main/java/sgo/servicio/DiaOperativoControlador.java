...
public class DiaOperativoControlador {
	...
	public @ResponseBody RespuestaCompuesta recuperarRegistros(HttpServletRequest httpRequest, Locale locale){
	 ...
	 @RequestMapping(value = URL_LISTAR_POR_DESCARGA_RELATIVA ,method = RequestMethod.GET)
	  public @ResponseBody RespuestaCompuesta recuperarDiasOperativosDescarga(HttpServletRequest httpRequest, Locale locale){
	    RespuestaCompuesta respuesta = null;
	    ParametrosListar parametros= null;
	    AuthenticatedUserDetails principal = null;
	    String mensajeRespuesta="";
	...
	public @ResponseBody Respuesta recuperaUltimoDia(int idOperacion,Locale locale){
