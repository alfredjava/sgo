...
public class EstacionDao {
	...
	public String mapearCampoOrdenamiento(String propiedad){
		...
		try {
			...
			if (propiedad.equals("fechaReferencia")){
				campoOrdenamiento="fecha_referencia";
			}
			if (propiedad.equals("codigoReferencia")){
				campoOrdenamiento="codigo_referencia";
			}
	...
	public RespuestaCompuesta guardarRegistro(Estacion estacion){
		...
		try {
			...
			consultaSQL.append(" (nombre,tipo,estado,id_operacion,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:Nombre,:Tipo,:Estado,:IdOperacion,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
			...
			listaParametros.addValue("SincronizadoEl", estacion.getSincronizadoEl());
			listaParametros.addValue("FechaReferencia", estacion.getFechaReferencia());
			listaParametros.addValue("CodigoReferencia", estacion.getCodigoReferencia());
	...
	public RespuestaCompuesta ActualizarEstadoRegistro(Cisterna cisterna){
		...
		try {
			...
			listaParametros.addValue("SincronizadoEl", cisterna.getSincronizadoEl());
			listaParametros.addValue("FechaReferencia", cisterna.getFechaReferencia());
			listaParametros.addValue("CodigoReferencia", cisterna.getCodigoReferencia());
			//Valores Auditoria
