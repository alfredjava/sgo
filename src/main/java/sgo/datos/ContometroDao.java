...
public class ContometroDao {
	...
	public RespuestaCompuesta guardarRegistro(Contometro contometro){
		...
		try {
			...
			consultaSQL.append(" (alias,estado,tipo_contometro,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion,id_estacion) ");
			consultaSQL.append(" VALUES (:Alias,:Estado,:TipoContometro,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion,:IdEstacion) ");
			...
			listaParametros.addValue("SincronizadoEl", contometro.getSincronizadoEl());
			listaParametros.addValue("FechaReferencia", contometro.getFechaReferencia());
			listaParametros.addValue("CodigoReferencia", contometro.getCodigoReferencia());
