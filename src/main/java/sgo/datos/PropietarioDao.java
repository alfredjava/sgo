...
public class PropietarioDao {
	...
	public RespuestaCompuesta guardarRegistro(Propietario propietario){
		...
		try {
			...
			consultaSQL.append(" (razon_social,nombre_corto,ruc,tipo,estado,creado_por,creado_el,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion,sincronizado_el,fecha_referencia,codigo_referencia) ");
			consultaSQL.append(" VALUES (:RazonSocial,:NombreCorto,:Ruc,:Tipo,:Estado,:CreadoPor,:CreadoEl,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion,:SincronizadoEl,:FechaReferencia,:CodigoReferencia) ");
			...
			listaParametros.addValue("SincronizadoEl", propietario.getSincronizadoEl());
			listaParametros.addValue("FechaReferencia", propietario.getFechaReferencia());
			listaParametros.addValue("CodigoReferencia", propietario.getCodigoReferencia());
