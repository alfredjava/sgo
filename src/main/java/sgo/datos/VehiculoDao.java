...
public class VehiculoDao {
	...
	public RespuestaCompuesta guardarRegistro(Vehiculo vehiculo){
		...
		try {
			...
			consultaSQL.append(" (nombre_corto,descripcion,id_propietario,estado,creado_por,creado_el,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion,sincronizado_el,fecha_referencia,codigo_referencia) ");
			consultaSQL.append(" VALUES (:NombreCorto,:Descripcion,:IdPropietario,:Estado,:CreadoPor,:CreadoEl,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion,:SincronizadoEl,:FechaReferencia,:CodigoReferencia) ");
			...
			listaParametros.addValue("SincronizadoEl", vehiculo.getSincronizadoEl());
			listaParametros.addValue("FechaReferencia", vehiculo.getFechaReferencia());
			listaParametros.addValue("CodigoReferencia", vehiculo.getCodigoReferencia());
