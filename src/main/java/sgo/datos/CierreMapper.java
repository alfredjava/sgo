...
public class CierreMapper implements RowMapper<Cierre>{
	public Cierre mapRow(ResultSet rs, int arg1) throws SQLException 
	{
		...
		try {
			...
			eCierre.setNombreUsuario(rs.getString("nombre_usuario"));
			eCierre.setNombreOperacion(rs.getString("nombre_operacion"));
			eCierre.setNombreCliente(rs.getString("nombre_cliente"));
