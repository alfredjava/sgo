...
public class AutorizacionDao {
	...
	public static final String NOMBRE_TABLA = Constante.ESQUEMA_APLICACION	+ "autorizacion";
	public static final String NOMBRE_VISTA = Constante.ESQUEMA_APLICACION	+ "v_autorizacion";
