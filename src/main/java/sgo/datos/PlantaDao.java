...
public class PlantaDao {
	...
	public RespuestaCompuesta guardarRegistro(Planta planta){
		...
		try {
			...
			consultaSQL.append(" (descripcion,estado,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion,sincronizado_el,fecha_referencia,codigo_referencia) ");
			consultaSQL.append(" VALUES (:Descripcion,:Estado,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion,:SincronizadoEl,:FechaReferencia,:CodigoReferencia) ");
