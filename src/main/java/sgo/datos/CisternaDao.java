...
public class CisternaDao {
	...
	public RespuestaCompuesta recuperarRegistros(ParametrosListar argumentosListar) {
		...
		try {
			...
			// Campos de auditoria
			consultaSQL.append(Utilidades.DATOS_AUDITORIA);
	...
	public RespuestaCompuesta guardarRegistro(Cisterna cisterna) {
		...
		try {
			...
			consultaSQL.append(" (placa, id_tracto, id_transportista,estado,sincronizado_el,fecha_referencia,codigo_referencia,cantidad_compartimentos,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:Placa, :IdTracto, :IdTransportista, :Estado,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CantidadCompartimentos,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
