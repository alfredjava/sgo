...
public class AutorizacionEjecutadaDao {
	...
	public static final String NOMBRE_TABLA = Constante.ESQUEMA_APLICACION	+ "autorizacion_ejecutada";
	public static final String NOMBRE_VISTA = Constante.ESQUEMA_APLICACION	+ "v_autorizacion_ejecutada";
