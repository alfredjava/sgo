...
public class TractoDao {
	...
	public String mapearCampoOrdenamiento(String propiedad){
		...
		try {
			...
			if (propiedad.equals("transportista.razonSocial")){
	...
	public RespuestaCompuesta guardarRegistro(Tracto tracto){
		...
		try {
			...
			consultaSQL.append(" (placa,estado,id_transportista,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:Placa,:Estado,:IdTransportista,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
