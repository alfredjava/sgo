...
public class ProductoDao {
	...
	public RespuestaCompuesta guardarRegistro(Producto producto){
		...
		try {
			...
			consultaSQL.append(" (nombre,codigo_osinerg,abreviatura,estado,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:Nombre,:CodigoOsinerg,:Abreviatura,:Estado,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
