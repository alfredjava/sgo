...
public class TransportistaDao {
	...
	public RespuestaCompuesta guardarRegistro(Transportista transportista){
		...
		try {
			...
			consultaSQL.append(" (razon_social,nombre_corto,ruc,estado,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:RazonSocial,:NombreCorto,:Ruc,:Estado,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
