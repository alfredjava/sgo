...
public class AutorizacionUsuarioDao {
	...
	public static final String NOMBRE_TABLA = Constante.ESQUEMA_APLICACION	+ "autorizacion_usuario";
	public static final String NOMBRE_VISTA = Constante.ESQUEMA_APLICACION	+ "v_autorizacion_usuario";
