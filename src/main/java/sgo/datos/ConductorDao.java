...
public class ConductorDao {
	...
	public RespuestaCompuesta guardarRegistro(Conductor conductor){
		...
		try {
			...
			consultaSQL.append(" (brevete,apellidos,nombres,dni,fecha_nacimiento,id_transportista,estado,sincronizado_el,fecha_referencia,codigo_referencia,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion) ");
			consultaSQL.append(" VALUES (:Brevete,:Apellidos,:Nombres,:Dni,:FechaNacimiento,:IdTransportista,:Estado,:SincronizadoEl,:FechaReferencia,:CodigoReferencia,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion) ");
