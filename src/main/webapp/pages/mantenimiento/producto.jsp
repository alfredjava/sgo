...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Producto<small> - Listado</small> </h1>
	</section>
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                <label>Nombre</label>
                <input name="cmpNombre" id="cmpNombre" type="text" class="form-control text-uppercase" maxlength="80"  required placeholder=""/>
                </div>
               <div class="form-group">
                <label>Codigo Osinerg</label>
                <input name="cmpCodigoOsinerg" id="cmpCodigoOsinerg" type="text" class="form-control text-uppercase" maxlength="5" required placeholder=""/>
                </div>
               <div class="form-group">
                <label>Abreviatura</label>
                <input name="cmpAbreviatura" id="cmpAbreviatura" type="text" class="form-control text-uppercase" maxlength="20" required placeholder=""/>
                </div>
                <div class="form-group">
	                <label>Estado</label>
          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <span id='vistaCodigoOsinerg'></span>
                </td>
              </tr>              
              <tr>
                <td> Abreviatura:</td>
                <td>
                <span id='vistaAbreviatura'></span>
                </td>
              </tr>              
              <tr>
                <td> Estado:</td>
