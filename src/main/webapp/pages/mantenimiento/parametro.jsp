...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Parametro<small> - Listado</small> </h1>
	</section>
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
              ...
              <div class="form-group">              
                <label>Valor</label>
                <input name="cmpValor" id="cmpValor" type="text" class="form-control text-uppercase" maxlength="80"  required placeholder="Ingresar Valor"/>
              </div>
              <div class="form-group">              
                <label>Alias</label>
