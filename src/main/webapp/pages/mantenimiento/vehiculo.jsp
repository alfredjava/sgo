...
<div class="content-wrapper">
	<section class="content-header">
    	<h1>Veh&iacute;culos<small> - Listado</small></h1>
  	</section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpNombreCorto" id="cmpNombreCorto" type="text" class="form-control text-uppercase" maxlength="20" required placeholder="Ingresar Nombe Corto"/>
                </div>
               <div class="form-group">
                <label>Descripci&oacute;n (Max. 80 caracteres)</label>
                <input name="cmpDescripcion" id="cmpDescripcion" type="text" class="form-control text-uppercase" maxlength="80" required placeholder="Ingresar Descripci&oacute;n"/>
                </div>                
              <div class="form-group">
                <label>Propietario</label>
                <select tipo-control="select2" id="cmpIdPropietario" name="cmpIdPropietario" class="form-control" style="width: 100%">
            ...
            <tbody>
             <tr>
              ...
              <tr>
                <td>Propietario:</td>
                <td>
                <span id='vistaIdPropietario'></span>
                </td>
              </tr>              
              <tr>
                <td>Estado:</td>
