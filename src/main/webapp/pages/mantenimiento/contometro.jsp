...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Contometro<small> - Listado</small> </h1>
	</section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpAlias" id="cmpAlias" type="text" class="form-control text-uppercase" maxlength="20" required placeholder="Ingresar Alias"/>
                </div>
               <div class="form-group">
                <label>Tipo</label>
                <select id="cmpTipoContometro" name="cmpTipoContometro" class="form-control">
            ...
            <tbody>
             <tr>
              ...
              <tr>
                <td>Alias:</td>
                <td>
                <span id='vistaAlias'></span>
                </td>
              </tr>              
              <tr>
                <td>Tipo :</td>
                <td>
                <span id='vistaTipoContometro'></span>
                </td>
              </tr> 
              <tr>
