$(document).ready(function(){
  ...
  moduloActual.mensajesValidacionFormulario={
	cmpTitulo: {
		...
		maxlength: "El campo debe contener 80 caracteres como m&aacute;ximo."
	},
	cmpUrlCompleta: {
		required: "El campo es obligatorio",
		maxlength: "El campo debe contener 100 caracteres como m&aacute;ximo."
	},
	cmpUrlRelativa: {
		required: "El campo es obligatorio",
		maxlength: "El campo debe contener 100 caracteres como m&aacute;ximo."
	...
	cmpPadre: "El campo es obligatorio",
	cmpTipo: "El campo es obligatorio",
  ...
  moduloActual.llenarDetalles = function(registro){
    ...
    this.obj.vistaCreadoEl.text(registro.creadoEl);
    this.obj.vistaCreadoPor.text(registro.creadoPor);
    this.obj.vistaActualizadoEl.text(registro.actualizadoEl);
    
    this.obj.vistaActualizadoPor.text(registro.actualizadoPor);
  };
