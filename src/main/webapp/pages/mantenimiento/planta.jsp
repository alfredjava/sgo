...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Plantas<small> - Listado</small> </h1>
	</section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpDescripcion" id="cmpDescripcion" type="text" class="form-control text-uppercase" maxlength="150" required placeholder="Ingresar Descrici&oacute;n"/>
                </div>
               <div class="form-group">
                <label>Estado</label>
