...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Tractos<small> - Listado</small></h1>
 </section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpPlaca" id="cmpPlaca" type="text" class="form-control text-uppercase" maxlength="15" required placeholder="Ingrese Placa"/>
               </div>
               <div class="form-group">
