$(document).ready(function(){
  ...
  moduloActual.columnasGrillaDiaOperativo.push({ "data": 'totalCisternas'});
  moduloActual.columnasGrillaDiaOperativo.push({ "data": 'totalCisternas'});
  ...
  moduloActual.definicionColumnasGrillaDiaOperativo.push({"targets" : 2,"searchable" : true, "orderable" : true, "visible" : true,"render" : utilitario.formatearFecha});
  moduloActual.definicionColumnasGrillaDiaOperativo.push({"targets" : 3,"searchable" : true, "orderable" : true, "visible" : true });
  moduloActual.definicionColumnasGrillaDiaOperativo.push({"targets" : 4,"searchable" : true, "orderable" : true, "visible" : true });
  moduloActual.definicionColumnasGrillaDiaOperativo.push({"targets" : 5,"searchable" : true, "orderable" : true, "visible" : true });
  ...
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'id'}); 
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'tanque.descripcion'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'fechaHoraInicial'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'alturaInicial'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'volumenCorregidoInicial'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'fechaHoraFinal'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'alturaFinal'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": 'volumenCorregidoFinal'});
  moduloActual.columnasGrillaCargaTanque.push({ "data": null});
  //Columnas Carga Tanque 
  moduloActual.definicionColumnasGrillaCargaTanque.push({
  "targets" : 1,
  "searchable" : true,
  "orderable" : true,
  "visible" : false
  ...
  "render": function ( datos, tipo, fila, meta ) {
      ...
      return parseFloat(fila.volumenCorregidoFinal)- parseFloat(fila.volumenCorregidoInicial);
    }
  });
